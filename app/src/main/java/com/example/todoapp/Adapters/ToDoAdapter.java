    ...
    public class ToDoHolder extends RecyclerView.ViewHolder {
        ...
        public ToDoHolder(@NonNull View itemView) {
            ...
            toDoCheckBox.setOnClickListener(view -> {
                ...
                DatabaseReference reference = FirebaseDatabase.getInstance("https://todoapp-32d07-default-rtdb.europe-west1.firebasedatabase.app/")
                        .getReference(FirebaseAuth.getInstance().getUid()).child(timePeriod);
                    ...
                    if (menuItem.getItemId() == R.id.toDoPopupDelete){
                        ...
                        builder.setPositiveButton(R.string.deleteToDoPossitiveMessage, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                Task<Void> delete = FirebaseDatabase.getInstance("https://todoapp-32d07-default-rtdb.europe-west1.firebasedatabase.app/")
                                        .getReference(FirebaseAuth.getInstance().getUid()).child(timePeriod).child(models.get(getAdapterPosition()).getId()).removeValue();
                        ...
                        builder.setNegativeButton(R.string.deleteToDoMessageNegativeMessage, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
